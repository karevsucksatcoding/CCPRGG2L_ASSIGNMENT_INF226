...
public class exercise1 {
    public static void main(String[] args) {
        ...
        System.out.print("Enter a 24 hour time following the (HH:MM:SS) pattern: ");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("\\S*(\\.jpg|\\.png|\\.xlsx|\\.txt)\\b");
        ...
        // Provide the pattern
        pattern = Pattern.compile("^(?=.*[^A-Za-z0-9])(?=\\S+$)[^E, L, I, Z, R]{10,}$");
